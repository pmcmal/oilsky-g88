...
- [5. Flashing Patched Boot Image]
- [6. Finishing Magisk Installation]
- [🔥 Firmware & Tools]
- [🎧 Viper4Android Installation]
- [🚀 Bonus & Future]
...
2. Use mtk client commands with the preloader flag extracted from the firmware link
...
🚀 Installation Steps
- Install Magical OverlayFS in Magisk & Reboot. (Allows RW permissions to /vendor).
- Install ACP in Magisk & Reboot.
- Install AML in Magisk & Reboot.
- Install Viper4Android RE in Magisk & Reboot.
- Install the Viper4Android APK.
